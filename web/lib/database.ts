 ...
 * Validates the response for 401 (Unauthorized) errors.
...
/**
 * addFacultyReview
 * Handles the submission of student feedback.
 * If review.isAnonymous is true, it overrides the student name for privacy.
 */
    ...
    const { error } = await supabase.from('faculty_reviews').insert([
      {
        ...
        // IT Logic: Mask the name if anonymity is requested by the student
